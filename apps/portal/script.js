...
const MODULES = [
    ...
    { id: 'vendas-miguel',  name: 'Vendas Miguel',         url: '/vendas',               available: true  },
    { id: 'vendas-isaque',  name: 'Vendas Isaque',         url: '/vendas',               available: true  },
...
const MODULE_ICONS = { /* ... cole o objeto completo de ícones ... */ };
